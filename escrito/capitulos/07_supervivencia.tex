...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{supervivencia_global.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{analisis_dual_combined.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{supervivencia_perfiles.png}
