...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{imagenes/poblacion_comparativa_combined.png}
    \caption{Comparativa de población estudiantil total vs. activa por generación para Matemáticas (izquierda) y Física (derecha).}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{imagenes/correccion_bt_2016_combined.png}
    \caption{Corrección dinámica de la Generación 2016 para Matemáticas (izquierda) y Física (derecha), transformando tiempo cronológico en tiempo activo.}
