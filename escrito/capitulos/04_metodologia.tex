...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/poblacion_comparativa_matematicas.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/boxplot_censura_gen_matematicas.png}
