...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/poblacion_comparativa_matematicas}
        \caption{Población total vs. activa (Matemáticas).}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/poblacion_comparativa_fisica}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/correccion_bt_2016_matematicas}
        \caption{Corrección dinámica Gen 2016 (Matemáticas).}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/correccion_bt_2016_fisica}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes/eda_media_semestre_termino}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/eda_boxplot_gen_matematicas}
        \caption{Distribución por generación (Matemáticas).}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/eda_boxplot_gen_fisica}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/pca_loadings_matematicas}
        \caption{Loadings PCA (Matemáticas).}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/pca_loadings_fisica}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/pca_scatter_matematicas}
        \caption{Proyección latente (Matemáticas).}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{imagenes/pca_scatter_fisica}
