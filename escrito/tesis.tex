...
\subsection{Demografía de la población filtrada}

Tras aplicar los criterios de exclusión (retiro de bajas temporales y definitivas), la población de estudio se consolida en un volumen de estudiantes que varía significativamente por generación. La siguiente figura ilustra el tamaño de las cohortes de ingreso efectivas para la licenciatura en Matemáticas a lo largo del periodo de estudio.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{poblacion_gen_matematicas}
    \caption{Población estudiantil efectiva por generación (Matemáticas), excluyendo bajas definitivas y temporales.}
    \label{fig:poblacion_matematicas}
\end{figure}

Es importante destacar que el análisis del rezago escolar se realiza sobre esta población que permaneció "activa" administrativamente, lo que más adelante introducirá el desafío metodológico de distinguir entre el rezago real y el abandono no declarado.
